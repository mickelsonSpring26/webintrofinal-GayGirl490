...
const skulltulaData = [
  ...
  },
  {
    ...
    description: "After breaking through the spider web and reaching the lower floor of the Great Deku Tree, turn back and look at the vines leading up. Shoot down the Skulltula with the Slingshot.",
  },
  {
    number: 3,
    areaType: "dungeons",
    ...
    description: "After breaking through the spider web and reaching the lower floor of the Great Deku Tree, look at the grating at the north end of the room to find another Skulltula.",
  },
  {
    number: 45,
    areaType: "overworld",
